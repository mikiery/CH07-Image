...
public class M0705 extends AppCompatActivity implements
    ...
    private void setupViewComponent() {
        ...
        Scissors = (ImageButton) findViewById(R.id.m0705_b001);
        Stone = (ImageButton) findViewById(R.id.m0705_b002);
        Net = (ImageButton) findViewById(R.id.m0705_b003);
...
//        r_layout.setAnimation(AnimationUtils.loadAnimation(this, R.anim.anim_scale_rotate_out));
    ...
    private View.OnClickListener buttonOn = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.m0705_b001:   //選擇剪刀  scissors
                    u_setalpha();//歸0一定要放上面
                ...
                case R.id.m0705_b002:   //我選擇石頭  stone
                    u_setalpha();
    ...
    private void music(int i) {
        ...
        switch (i) {
            case 1:
                ...
                musichaha.start();
                Toast.makeText(getApplicationContext(), R.string.m0705_f003, Toast.LENGTH_SHORT).show();
                break;
            case 2:

                musiclose.start();
                Toast.makeText(getApplicationContext(), R.string.m0705_f002, Toast.LENGTH_SHORT).show();
                break;
            case 3:
